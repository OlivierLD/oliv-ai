# USAGE
# python ocr_form.py --image scans/scan_01.jpg --template form_w4.png --verbose true|false
...
print("Usage is 'python ocr_form.py --image scans/scan_01.jpg --template form_w4.png [--verbose true]'")
print("         'python ocr_form.py -i scans/scan_01.jpg -t form_w4.png [-v true]'")
...
OCRLocation = namedtuple("OCRLocation",
                         ["id", "bbox", "filter_keywords"])
...
print("Select an image, and hit a key to terminate the program.")
cv2.waitKey(0)
