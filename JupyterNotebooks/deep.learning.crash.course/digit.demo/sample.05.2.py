...
#
# Similar to sample.05.1.py, but with YOUR own images, stored on the file system.
# Model training.h5 must already exist
# Uses OpenCV to reshape the images as expected by the model (not to take snapshots).
#
